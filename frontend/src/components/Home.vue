    ...
    <div class="card">
      ...
      <div class="home-center">
        ...
        <div class="home-info" v-if="user.token && !isStarted">
          ...
          <h3>Дорогие друзья! В связи с объявленным в Ногинске трауром фестиваль «Торговый город» будет отложен до
            другой субботы сентября.</h3>
          <h3>Пожалуйста, следите за обновлениями в наших соцсетях.</h3>

          <h3>Берегите себя и своих близких.</h3>
